...
local CONFIG = {
	...
	ffont = {"Font", "string", "",
	   "Sets the font for the Gradient Text\nFonts are Stored in garrysmod/resource/fonts"
	}
}
...
local MANIFEST = {
    ...
    author = "djsime1 Vee",
    name = "Background customizer improved",
    description = "Replaces menu background with gradients & custom text.",
    version = "1.0\n(Modification of DJSime1's 1.2 Build)",
    config = CONFIG
}
...
local function reload()
	...
	local font = menup.config.get(MANIFEST.id, "ffont", "")
